                ...
                <div class="card-title-group mb-4 align-items-start">
                  <div class="card-title">
                    ...
                    <div>
                      ...
                      </span><a href="/profile">Change Timezone</a>
                    </div>
                  </div>
                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#planTypeModal">
                    Launch static
                    backdrop modal</button>
                  <div class="card-tools">
                    <div class="dropdown">
                      <a href="#" class="btn btn-sm btn-icon btn-zoom me-n1" data-bs-toggle="dropdown"><em
                      ...
                      <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                          <a href="#" class="dropdown-item">New Ticket</a>
                        </li>
                        <li>
                          <a href="#" class="dropdown-item">New Customer</a>
                        </li>
                        <li>
                          <a href="#" class="dropdown-item">New Contact</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="row g-gs">
                  <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                    <div class="box-dotted h-100">
                      <em class="icon icon-lg ni ni-chart-up text-primary"></em>
                  ...
                  <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4">
                    <div class="box-dotted h-100">
                      <em class="icon icon-lg ni ni-user-add text-success"></em>
                      <h5 class="title mt-2 mb-3">
                        Instagram Followers
                      </h5>
                  ...
                  <div class="col-md-4 col-lg-12 col-xl-4">
                    <div class="box-dotted h-100">
                      <em class="icon icon-lg ni ni-coins text-warning"></em>
            ...
            <div class="card h-100">
              <div class="card-body">
                <div class="card-title-group">
                  ...
                  <div class="card-tools">
                    <em class="icon-hint icon ni ni-help-fill" data-bs-toggle="tooltip" data-bs-placement="left"
                      title="Sessions from device"></em>
                  </div>
                </div>

				...
				<div class="col-lg-6 col-md-12 col-sm-12 mx-auto align-self-center">
					<div class="login-form">
						...
						<form action="/login" method="POST">
							<div class="mb-4">
								<label class="mb-1 text-dark">Email or Username</label>
								<input type="text" class="form-control form-control" name="identifier" id="identifier"
									placeholder="Enter Email or Username" required>
							</div>
							<div class="mb-4 position-relative">
								<label class="mb-1 text-dark">Password</label>
								<input type="password" name="password" id="dlab-password" class="form-control form-control"
								...
								<div class="mb-4">
									<div class="form-check custom-checkbox mb-3">
										<input type="checkbox" class="form-check-input" id="customCheckBox1"
											name="remember_me" value="1" <?php echo (isset($rememberMeToken) ? 'checked="checked"' : ''); ?>>
										<label class="form-check-label mt-1" for="customCheckBox1">Remember my
											preference</label>
									</div>
								</div>
								<div class="mb-4">
									<a href="/forgot-password" class="btn-link text-primary">Forgot Password?</a>
								</div>
							</div>

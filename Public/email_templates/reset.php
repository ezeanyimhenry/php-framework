                                  ...
                                  <tr>
                                    ...
                                    >
                                      <img
                                        align="center"
                                        border="0"
                                        src="{{websiteURL}}/public/images/logo.png"
                                        alt="Image"
                                        title="Image"
                                        style="
                                          outline: none;
                                ...
                                <p style="font-size: 14px; line-height: 140%">
                                  <span
                                    style="
                                      ...
                                      color: #666666;
                                    "
                                    >You have made a request to reset your account password. Your One Time Password (OTP) is</span
                                  >
                                </p>
                                <p style="font-size: 14px; line-height: 140%">
                                   
                                </p>
                                <h1 style="font-size: 30px; line-height: 140%;">
                                  <span
                                    style="
                                      font-size: 30px;
                                      line-height: 25.2px;
                                ...
                                <p style="font-size: 14px; line-height: 140%">
                                  <span
                                    style="
                                      ...
                                      color: #666666;
                                    "
                                    >If you didn't request a password reset, feel free to delete this email and continue with signing in</span
                                  >
                                </p>
                              </div>
                            </td>
                            ...
                            <tr>
                              ...
                              >
                                ...
                                <div class="v-text-align" align="left">
                                  <!--[if mso]><v:roundrect xmlns:v='urn:schemas-microsoft-com:vml' xmlns:w='urn:schemas-microsoft-com:office:word' href='{$url}' style='height:49px; v-text-anchor:middle; width:164px;' arcsize='2%'  stroke='f' fillcolor='#131372'><w:anchorlock/><center style='color:#FFFFFF;font-family:Lato,sans-serif;'><![endif]-->
                                  <a
                                    href="{{websiteURL}}"
                                    target="_blank"
                              ...
                              >
                                ...
                                >
                                  <p style="line-height: 140%">
                                    Copyright ©<?= date('Y')?> {{websiteName}}. All
                                    Rights Reserved.
                                  </p>
                                </div>
                              </td>
